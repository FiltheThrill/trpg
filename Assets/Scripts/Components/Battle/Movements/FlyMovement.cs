...
public class FlyMovement : Movement
{
    public override IEnumerator Traverse(Tile tile){
      ...
      float duration = (y - jumper.localPosition.y) * 0.5f;
      ...
      Directions dir;
      Vector3 toTile = (tile.center - transform.localPosition);
      ...
      duration = dist * 0.5f;
      tweener = transform.MoveToLocal(tile.center, duration, EasingEquations.EaseInOutQuad);
